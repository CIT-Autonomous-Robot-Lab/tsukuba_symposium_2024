...
簡素なロボットで屋外環境を安全に自律走行できるシステムの開発を目的とし, 
%#2021年からつくばチャレンジに参加してきた。
2021年からつくばチャレンジへの参加を続けている. 
%#今年度のつくばチャレンジ2024では、
つくばチャレンジ2024では、
...
またきなこチームでは、
%%%むぎまるにあるような何に注力したかの説明ほしい？有無は統一したほうがきれいな気がします。
開発においての目標を「動的障害物が多い中でも動作する自己位置推定器の開発」
として活動した。
%%%本稿の構成の話になるので次の段落に合体したほうが良さそう？
...
%%%Raspberry Piはメモリが大きいやつに交換されていた気がします。ラズパイのことに触れなくていいと思います。
...
%#    きなこチーム　 & 6m    & スタート直後に左へ旋回し道路へでたためその場でリアイア \\
    きなこチーム　 & 6m    & スタート直後に左旋回し, 道路へコースアウトしたためリアイア \\
    \hline
  \end{tabular}
\end{table}
...
%4章で述べたものに取り組み、
4章で述べた価値反復を用いた経路計画の実装？に取り組み、
コースの完走を目指す。
%

\section*{謝辞}
つくばチャレンジ実行委員会、つくば市の皆様に感謝申し上げます。
%上田研究室の新井亮大氏、登内リオン氏，松井大和氏，山崎政光氏，
